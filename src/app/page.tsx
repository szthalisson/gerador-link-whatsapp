  ...
  return (
    <>
      <header className="flex w-full flex-col items-center pt-5">
        <h1 className="text-4xl md:text-7xl select-none">Link Generator</h1>
        <h1 className="text-3xl text-[#25D366] md:text-5xl select-none">
          Whatsapp
        </h1>
      </header>
      ...
      <footer className="absolute bottom-1 w-full text-center">
        <span>Developer </span>
        <a
          href="https://instagram.com/dev.thalisson"
